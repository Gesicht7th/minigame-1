// Assets/Game/ScriptableObjects/Scripts/HyperSmash/HyperSmashTutorialReadyController.cs
// Mengelola input tutorial panel menggunakan dual wand controller untuk HyperSmash.
...
{
    public class HyperSmashTutorialReadyController : MonoBehaviour
    {
        [Header("── Wand Readers ─────────────────────")]
        ...
        [Tooltip("HyperSmashDummieUIManager di scene ini")]
        ...
        /// (Visibility cursor di-handle oleh GameManager)
        /// </summary>
